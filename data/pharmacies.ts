...
export const pharmacies: Pharmacy[] = [
  { id: '1', name: 'Farmacia Malaga 1', phone: '011-4567-8901', address: 'Av. Corrientes 1234', neighborhood: 'Centro', lat: -34.6037, lng: -58.3816, hours: 'Lun a Vie 8:00-20:00, Sáb 9:00-14:00', services: ['Inyectables', 'Medición de presión', 'Perfumería'], isOnDuty: false },
  { id: '2', name: 'Farmacia del Este', phone: '011-4567-8902', address: 'Av. Santa Fe 3456', neighborhood: 'Palermo', lat: -34.5875, lng: -58.4052, hours: 'Lun a Dom 9:00-22:00', services: ['Inyectables', 'Ortopedia', 'Dermocosmética'], isOnDuty: true },
  { id: '3', name: 'Farmacia del Este 3', phone: '011-4567-8903', address: 'Av. Cabildo 2345', neighborhood: 'Belgrano', lat: -34.5553, lng: -58.4590, hours: 'Lun a Vie 8:30-21:00, Sáb 9:00-18:00', services: ['Inyectables', 'Medición de presión', 'Vacunación'], isOnDuty: false },
  { id: '4', name: 'Farmacia Caballito', phone: '011-4567-8904', address: 'Av. Rivadavia 5678', neighborhood: 'Caballito', lat: -34.6177, lng: -58.4403, hours: 'Abierto 24 horas', services: ['Inyectables', 'Medición de presión', 'Perfumería', 'Guardia 24hs'], isOnDuty: true },
  { id: '5', name: 'Farmacia del Este 2', phone: '011-4567-8905', address: 'Av. Callao 1890', neighborhood: 'Recoleta', lat: -34.5922, lng: -58.3922, hours: 'Lun a Vie 8:00-20:00, Sáb 9:00-13:00', services: ['Inyectables', 'Dermocosmética', 'Ortopedia'], isOnDuty: false },
  { id: '6', name: 'Farmacia Juan B Justo', phone: '011-4567-8906', address: 'Av. Triunvirato 4567', neighborhood: 'Villa Urquiza', lat: -34.5682, lng: -58.4821, hours: 'Lun a Sáb 9:00-21:00', services: ['Inyectables', 'Medición de presión'], isOnDuty: false },
  { id: '7', name: 'Farmacia Jujuy', phone: '011-4567-8907', address: 'Av. Avellaneda 3210', neighborhood: 'Flores', lat: -34.6282, lng: -58.4639, hours: 'Lun a Vie 8:00-19:00, Sáb 9:00-14:00', services: ['Inyectables', 'Perfumería'], isOnDuty: false },
  ...
  { id: '9', name: 'Farmacia Malaga', phone: '011-4567-8909', address: 'Av. Cabildo 4567', neighborhood: 'Núñez', lat: -34.5432, lng: -58.4625, hours: 'Lun a Vie 8:30-20:00, Sáb 9:00-15:00', services: ['Inyectables', 'Medición de presión', 'Ortopedia'], isOnDuty: false },
  ...
  { id: '21', name: 'Farmacia Yerba Buena', phone: '0381-425-6789', address: 'Av. Aconquija 1000', neighborhood: 'Yerba Buena', lat: -26.8167, lng: -65.2833, hours: 'Lun a Dom 8:00-00:00', services: ['Inyectables', 'Medición de presión', 'Perfumería'], isOnDuty: false },
  { id: '22', name: 'Farmacia San Miguel', phone: '0381-421-1234', address: '25 de Mayo 500', neighborhood: 'San Miguel de Tucumán', lat: -26.8241, lng: -65.2039, hours: 'Abierto 24 horas', services: ['Inyectables', 'Medición de presión', 'Perfumería', 'Guardia 24hs'], isOnDuty: true },
];
